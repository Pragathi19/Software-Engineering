...
<meta http-equiv="refresh" content="60;admin_home.php" />
...
.card{
  ...
  <body>
   ...
   <div class="jumbotron w-25 p-2 d-inline-block float-left" style="height: 150px; margin-right: 15px;">
...
<div class="card" id="netbox" style="background-color: #f7f8f9">
 ...
 <div class="power" style="margin-top: 50px">
...
<label style="font-size: 20px">Fare:</label>
<?php
                                $q="select fare from trip where userid='$id'";
                                $result=mysqli_query($con,$q);
                                $row = mysqli_fetch_array($result)


                                ?>
                                <h5 style="font-size: 20px,font-weight:bold"><?php echo "   ";echo $row['fare']; ?> </h5>
  ...
  <div class="form-group" style="margin-top: 50px;">
    <div class="col-auto">
      ...
      <div class="input-group mb-2">
        ...
        <input type="number" class="form-control" id="inlineFormInputGroup" placeholder="Enter Card Number" name="cdnum" maxlength="16" minlength="16">
      </div>
    </div>
  </div>
