...
<nav class="navbar navbar-dark bg-dark">
 ...
 <div class="head ">
  ...
  <p class="bounceIn animated" style="text-align: center;  font-size: 75px"><font color="silver">Experience the best Rides in your city.</p>
   ...
   <a href="viewcab.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left: 725px; width: 200px; height: 100px;"><span> View Cabs </span></button></a>
   <button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;" data-toggle="modal" data-target="#exampleModalCenter"><span> Add Cabs </span></button>
...
<!-- Modal 1-->
  ...
  <div class="modal-dialog modal-dialog-centered" role="document" >
    <div class="modal-content" >
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Add Cabs</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form name="addcab" action="addcab.php" method="post">

        <!-- Sign up page-->

 
    <div class="form-group">
      <label for="inputCarNumber">Cab-Number</label>
      <input type="text" class="form-control" id="inputCabNumber" name="cab_no" placeholder="Car-Number">
    </div>

  <div class="form-group">
      <label for="inputCarType">Cab-Type</label>
      <select id="inputCarType" name="cab_type" class="form-control">
  ...
  <div class="form-group">
    <label for="inputAddress">Car-Availability</label>
  ...
  <div class="form-group">
    <label for="inputAddress">AC/NON-AC</label>
    <select id="inputAC" class="form-control" name="AC">
        <option value="">Select Car-Satatus</option>
...
<!--Modal 1 End-->
   ...
   <a href="deletecab.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;"><span> Delete Cabs </span></button></a>
