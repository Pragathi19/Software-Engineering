...
<nav class="navbar navbar-dark bg-dark">
 ...
 <div class="head ">
  ...
  <p class="bounceIn animated" style="text-align: center; font-size: 75px">Experience the best Rides in your city.</p>
   ...
   <a href="viewc.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:700px; width: 500px; height: 100px;"><span> View Customer Details </span></button></a>
