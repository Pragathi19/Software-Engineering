  ...
  <div class="container">
        <div class="table-wrapper" >
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-8"><h2><b>Booking details<b></h2></div>
                </div>
            </div>
            <table id="table" class="table table-bordered">
                ...
                <tbody>
                    <?php
                 foreach($con->query("SELECT * from cab;") as $row){
                 ?>
            ...
            <form action="deletecabval.php" method="post">
              <label style="font-size: 20px">Enter the Cab number</label>
              <input type="text" name="cab_number">
