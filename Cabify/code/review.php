...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item ">
        <a class="nav-link" id="pass" href="customer_home.php "><i class="fas fa-home"></i><strong> HOME <span class="sr-only">(current)</span></strong></a>
      </li>
    ...
    <div class="card" style="margin-top: 80px; margin-left: 40px;">
      <div class="card-body">
        ...
        <form action="php/submit_reviews.php" method="post">
         ...
         <input class="form-control" id="text" rows="3" style="height:100px;" name="comments"></input>
        </div>
