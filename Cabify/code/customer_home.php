...
<nav class="navbar navbar-dark bg-dark">
 ...
 <div class="head ">
  ...
  <p class="bounceIn animated" style="text-align: center; font-size: 75px">Experience the best Rides in your city.</p>

   <a href="new_booking.html"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left: 725px; width: 200px; height: 100px;"><span> Book a cab </span></button></a>
   <a href="cancelcab.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;"><span> Cancel booking</span></button></a>
   <a href="viewbooking.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;"><span> Booking history </span></button></a>
