<?php
$error="";$success="";if(isset($_POST['submit'])){  include 'dbconnection.php';
  $email=$_POST['email'];  $pswd=$_POST['pswd'];  $q1="select email,password from admin where email='$email' and password='$pswd'";  $result1=mysqli_query($con,$q1);  $row=mysqli_fetch_assoc($result1);
  $_SESSION['email']=$row['email'];  $num1=mysqli_num_rows($result1);  if($num1==1)  {    header("Location:admin_home.php");  }  else  {    $error="INVALID USERNAME OR PASSWORD!!....TRY AGAIN";    $success="";  }
}
?>
...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" id="pass" href="admin_login.php" ><i class="fas fa-home"></i><strong> HOME <span class="sr-only">(current)</span></strong></a>
      </li>
    ...
    <form class="form-inline" action="avalidation.php" method="post">
  ...
  <div class="input-group mb-2 mr-sm-2">
    ...
    <input type="email" name="email" class="form-control" style="width: 140px;" placeholder="Username">
  </div>
