...
<div class="container bootstrap snippet">
    ...
    <div style="width: 200px; height: 200px;">
        ...
        <?php 
        $q1="select image from driver where driverid='$id'";
            ...
            <table class="table table-bordered" style="width: 100%; height:100%;" >                  
              <tbody>
                <tr>
                  ...
                  <td><h4>Name : </h4></td>
                  <td><?php
                                $q="select name from driver where driverid='$id'";
                ...
                <tr>
                    ...
                    <td><h4>Email ID : </h4></td>
                     <td><?php
                                $q="select email from driver where driverid='$id'";
                                $result=mysqli_query($con,$q);
                                $row = mysqli_fetch_array($result)
                 ...
                 <tr>
                    ...
                    <td><h4>Contact Number : </h4></td>
                     <td> <?php
                                $q="select contact_number from driver where driverid='$id'";
                                $result=mysqli_query($con,$q);
                                $row = mysqli_fetch_array($result)
                 ...
                 <tr>
                    ...
                    <td><h4>Address : </h4></td>
                     <td><?php
                                $q="select address from driver where driverid='$id'";
                                $result=mysqli_query($con,$q);
                                $row = mysqli_fetch_array($result)
