...
<nav class="navbar navbar-dark bg-dark">
 ...
 <div class="head ">
  ...
  <p class="bounceIn animated" style="text-align: center; font-size: 75px">Experience the best Rides in your city.</p>
   ...
   <a href="cab.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left: 725px; width: 200px; height: 100px;"><span> CABS </span></button></a>
   <a href="cust.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;"><span> CUSTOMER </span></button></a>
   <a href="drv.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 200px; height: 100px;"><span> DRIVER </span></button></a>
