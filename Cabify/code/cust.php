...
<nav class="navbar navbar-dark bg-dark">
 ...
 <div class="head ">
  ...
  <p class="bounceIn animated" style="text-align: center;  font-size: 75px"><font color="silver">Experience the best Rides in your city.</p>
   ...
   <a href="viewcustomer.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left: 725px; width: 300px; height: 100px;"><span> View Customer Details </span></button></a>
   

   <a href="viewbooking1.php"><button type="button" class="btn btn-danger btn-lg mybtn" style="vertical-align:middle; margin-top: 430px; margin-left:10px; width: 300px; height: 100px;"><span> View Booking Details </span></button></a>
